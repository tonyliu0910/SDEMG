...
if __name__ == '__main__':
    ...
    parser.add_argument('--project_name', default='Diffusion_UNet_TS50k_SS2k', help='project name')
    parser.add_argument('--batch_size', default=1, type=int, help='batch size')
    parser.add_argument('--root_dir', default='.', help='root directory for data and model storage')
    parser.add_argument('--clean_dir', default='/work/t22302856/Tony_data/data_E2_S40_Ch9_withSTI_seg60s_nsrd/train/clean', help='directory containing clean EMG waveforms')
    parser.add_argument('--test_dir', default='/work/t22302856/Tony_data/data_E2_S40_Ch9_withSTI_seg60s_nsrd/test', help='directory containing noisy EMG waveforms') 
    ...
    parser.add_argument('--sampling_steps', default=2000, type=int, help='number of sampling steps')
