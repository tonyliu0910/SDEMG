...
if __name__ == '__main__':
    ...
    parser.add_argument('--project_name', default='UNet_Baseline_TS10k_SS1k', help='project name')
    ...
    parser.add_argument('--denoise_timesteps', default=1000, type=int, help='denoise step')
