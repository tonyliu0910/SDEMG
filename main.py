...
from dataset import CleanEMGDataset, EMGDataset
...
def main(args):
    ...
    inference_milestone = default(args.inference_milestone, int(args.train_steps / 100))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--project_name', default='Condition_UNet_TS10000_SS100', help='project name')
    parser.add_argument('--batch_size', default=2, type=int, help='batch size')
    parser.add_argument('--root_dir', default='.', help='root directory for data and model storage')
    parser.add_argument('--train_dir', default='/work/bigtony0910/dataset/train_E1_S40_Ch2_withSTI_seg30s_nsrd', help='directory containing training EMG waveforms')
    parser.add_argument('--test_dir', default='/work/bigtony0910/dataset/test_E2_S40_Ch9_withSTI_seg30s_nsrd', help='directory containing testing EMG waveforms') 
    ...
    parser.add_argument('--seq_length', default=30000, type=int, help='length of sequence')
